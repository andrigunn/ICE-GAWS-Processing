...
rootdir = 'C:\Users\andrigun\Dropbox\01-Projects\ICE-GAWS-Processing\data';
...
%% Write tables out
writetable(S,'C:\Users\andrigun\Dropbox\01-Projects\ICE-GAWS-Processing\data\ICE-GAWS-location-summary.csv')
%%
L1_filelist = rmfield(L1_filelist, {'folder', 'year2', 'site_name2'});
%%
L1_filelist = struct2table(L1_filelist);
writetable(L1_filelist,'C:\Users\andrigun\Dropbox\01-Projects\ICE-GAWS-Processing\data\ICE-GAWS-file-overview.csv')
