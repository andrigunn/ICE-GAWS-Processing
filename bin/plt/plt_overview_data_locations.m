...
% read location table
if ispc
    ICE_GAWS_location = readtable('C:\Users\andrigun\Dropbox\01-Projects\ICE-GAWS-Data\data\ICE-GAWS-location.csv')
elseif ismac
    ICE_GAWS_location = readtable('/Users/andrigun/Dropbox/01-Projects/ICE-GAWS-Data/data/ICE-GAWS-location.csv')
end
...
if ispc
    writetable(S,'C:\Users\andrigun\Dropbox\01-Projects\ICE-GAWS-Data\data\ICE-GAWS-location-summary.csv')
elseif ismac 
    writetable(S,'/Users/andrigun/Dropbox/01-Projects/ICE-GAWS-Data/data/ICE-GAWS-location-summary.csv')
end

%%
close all
h = figure
geobubble(S,'lat_ave','lon_ave','MapLayout','maximized',SizeVariable='no_years',ColorVariable='station_cat')
